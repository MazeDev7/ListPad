...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String TODOITEM = "com.ali.com.ali.todolist.MainActivity";
    ...
    public static final String SHARED_PREF_DATA_SET_CHANGED = "com.ali.datasetchanged";
    public static final String CHANGE_OCCURED = "com.ali.changeoccured";
    private int mTheme = -1;
    private String theme = "name_of_the_theme";
    public static final String THEME_PREFERENCES = "com.ali.themepref";
    public static final String RECREATE_ACTIVITY = "com.ali.recreateactivity";
    public static final String THEME_SAVED = "com.ali.savedtheme";
    public static final String DARKTHEME = "com.ali.darktheme";
    public static final String LIGHTTHEME = "com.ali.lighttheme";
    private AnalyticsApplication app;

// This function is to obtain the user input and store them in an ArrayList items.
    ...
    protected void onResume() {
        ...
        /*
        This activity's onCreate won't be called when coming back from SettingsActivity,
        so our changes to dark/light mode won't take place, as the setContentView() is not called again.
